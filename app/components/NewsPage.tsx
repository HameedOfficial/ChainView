    ...
    <div>
      ...
      <div className="controls-wrap" style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16, flexWrap: "wrap", gap: 10 }}>
        ...
        <input
          ...
          style={{ background: "#1a1a2e", border: "1px solid #2a2a3e", borderRadius: 10, padding: "7px 13px", color: "#fff", fontSize: 13, outline: "none", width: 200 }}
        />
      </div>
      ...
      {loading ? (
        <div className="grid-news" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(280px, 1fr))", gap: 12 }}>
          {[...Array(12)].map((_, i) => (
            <div key={i} style={{ background: "#111122", border: "1px solid #1e1e3a", borderRadius: 12, overflow: "hidden" }}>
